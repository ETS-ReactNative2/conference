...
class ConferenceDay extends Component {
    ...
    renderDayHeader() {
        ...
        if (this.props.day.title) {
            return <Text style={styles.dayHeader} adjustsFontSizeToFit>{this.props.day.title.toUpperCase()} - {I18n.t(`common.months.${month}`).toUpperCase()} {day}, {year}</Text>
        } else {
            return <Text style={styles.dayHeader} adjustsFontSizeToFit>{I18n.t(`common.months.${month}`).toUpperCase()} {day}, {year}</Text>
        }
    }
