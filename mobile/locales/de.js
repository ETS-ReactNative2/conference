export default {
  ...
  'flow_page': {
    ...
    'industries': {
      'title': '_DE_Which industry you work in?'
    },
    'investee': {
      'project_location': {
        'title': '_DE_Project location',
        'main': '_DE_Main office location',
        'legal': '_DE_Company legal location'
      }
    },
    'employee': {
      'role': {
        'title': '_DE_Role',
        'looking_for_job': '_DE_Are you looking for job?'
      },
      'job': {
        'city': '_DE_City'
      },
      'relocate': '_DE_Are you willing to relocate?',
      'remote': '_DE_Are you willing to work remote?',
      'skills': {
    ...
    'investor': {
      ...
      'invest_in': {
        'title': '_DE_I want to invest in:',
        'investment_topics': {
          'protocols': '_DE_Protocols',
          'app_tokens': '_DE_App Tokens',
          'security_tokens': '_DE_Security Tokens'
        }
      },
      'ticket_size': {
        'title': '_DE_Ticket size:'
      },
